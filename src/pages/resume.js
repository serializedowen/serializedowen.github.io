...
import { Wrapper, Header, Content } from 'components'
  ...
  return (
    <Wrapper>
      ...
      <Content>
        ...
        <ul>
          <li>
            Responsible for developing a full stack SPA to manage all veterinary
            health products throughout Canada. (React/PHP)
          </li>
          <li>
          ...
          <li>
            Modernized and standardized the company codebase; integrated Eslint
            and webpack ; migrated from grunt
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            and developing algorithms to predict new status given real-time data
          </li>
          <li>
            Received feedback for being a quick learner and demonstrated strong
            initiative at work
          </li>
          <li>
          ...
          <li>
            Optimized the algorithm and significantly lowered the classification
            error rate
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Developed solid understanding of algorithms and methodologies during
            the process of developing and deploying new tests;
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Designed and developed a fully functional website aiming for hook up
            undergrads and start-ups using MEAN stack, deployed at:{' '}
        ...
        <ul>
          ...
          <li>
            Pioneer in open source developement, developed multiple open-source
            tool/gadget range from vue-cli twinks to image watermark generator.
          ...
          <li>
            Functional Programming / Event-driven Programming evangelist, strong
            believer of &ldquo;Any application that can be written in
        ...
        <ul>
          <li>
            ...
            Stream, notable courses includes: Introduction to machine learning,
            Introduction to artificial intelligence, Web Development;
          </li>
          <li>
